...
CREATE TABLE [dbo].[Building] (
    ...
    UNIQUE NONCLUSTERED ([Buildingcode] ASC),
    UNIQUE NONCLUSTERED ([BuildingName] ASC)
);
...
CREATE TABLE [dbo].[Comments] (
    ...
    [SetInOrder]   VARCHAR (255) NULL,
    [Shine]        VARCHAR (255) NULL,
    [Standarize]   VARCHAR (255) NULL,
    [Sustain]      VARCHAR (255) NULL,
...
GO
PRINT N'Creating Table [dbo].[SpaceImage]...';
...
ALTER TABLE [dbo].[Comments]
    ADD CONSTRAINT [FK_CommentSpace] FOREIGN KEY ([RatingId]) REFERENCES [dbo].[Ratings] ([Id]) ON DELETE CASCADE;
...
GO
PRINT N'Creating Foreign Key [dbo].[FK_SpaceImage_Space]...';


GO
ALTER TABLE [dbo].[SpaceImage]
    ADD CONSTRAINT [FK_SpaceImage_Space] FOREIGN KEY ([SpaceId]) REFERENCES [dbo].[Spaces] ([Id]);
